...
<div style="margin-bottom: 20px; margin-top: 10px;">
	<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; border-bottom: 1px solid #dcdcdc; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">
		<thead style="background-color:#dcdcdc">
			<tr>
				<th class="td" scope="col" style="text-align:left;border-top: 1px solid #dcdcdc;"><?php esc_html_e( 'Product', 'smart-emails' ); ?></th>
				<th></th>
				<th class="td" scope="col" style="text-align:center;border-top: 1px solid #dcdcdc;width: 1px;"><?php esc_html_e( 'Quantity', 'smart-emails' ); ?></th>
				<th class="td" scope="col" style="text-align:right;border-top: 1px solid #dcdcdc;width: 1px;"><?php esc_html_e( 'Price', 'smart-emails' ); ?></th>
			</tr>
		</thead>
		<tbody>
			<?php
