...
$template_footer = 'background-color:' . $se_style_settings['footer_color'] . ';
                margin-bottom: 15px;
				width:95%;
				color:' . $se_style_settings['footer_text_color'] . ';';
?> 
										...
										<tr>
											<td valign="top">
												<table border="0" cellpadding="10" cellspacing="0" width="100%">
													<tr>
														<td colspan="2" valign="middle" id="credit" class="se_footer" style="<?php echo esc_attr( $template_footer ); ?>">
															<?php
													...
													<tr>	
														<td style="padding: 20px 30px" valign="middle" id="credit"> 
															<?php
															if ( ! empty( $se_brand_identity['twitter_link'] ) ) {
																...
																<a id="twitter_link" href=<?php echo esc_url( $se_brand_identity['twitter_link'] ); ?>>
																	...
																	if ( ! empty( $se_brand_identity['twitter_logo'] ) ) {
																		...
																		$twitter_logo = SA_SE_PLUGIN_URL . '/assets/images/classic/twitter.png';
																	}
																	?>
															...
															if ( ! empty( $se_brand_identity['facebook_link'] ) ) {
																...
																<a id="facebook_link" href=<?php echo esc_url( $se_brand_identity['facebook_link'] ); ?>>
																	...
																	if ( ! empty( $se_brand_identity['facebook_logo'] ) ) {
																		...
																		$facebook_logo = SA_SE_PLUGIN_URL . '/assets/images/classic/facebook.png';
																	}
																	?>
															...
															if ( ! empty( $se_brand_identity['instagram_link'] ) ) {
																...
																<a id="instagram_link" href=<?php echo esc_url( $se_brand_identity['instagram_link'] ); ?>>
																	...
																	if ( ! empty( $se_brand_identity['instagram_logo'] ) ) {
																		...
																		$instagram_logo = SA_SE_PLUGIN_URL . '/assets/images/classic/instagram.png';
																	}
																	?>
