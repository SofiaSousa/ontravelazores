...
<table class="td" id="order-downloads" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; margin-bottom: 40px;">
	<thead>
		<tr>
			<?php
			foreach ( $columns as $column_id => $column_name ) :
				$head_text_align = ( 'download-file' === $column_id ) ? 'right' : $text_align;
				?>
				<th class="td" scope="col" style="text-align:<?php echo esc_attr( $head_text_align ); ?>;"><?php echo esc_html( $column_name ); ?></th>
			<?php endforeach; ?>
		</tr>
	</thead>
	...
	<?php foreach ( $downloads as $download ) : ?>
		<tr>
			<?php
			foreach ( $columns as $column_id => $column_name ) :
				$body_text_align = ( 'download-file' === $column_id ) ? 'right' : $text_align;
				?>
				<td class="td" style="text-align:<?php echo esc_attr( $body_text_align ); ?>;">
					<?php
