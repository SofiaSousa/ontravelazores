...
<table id="addresses" cellspacing="0" cellpadding="0" border="0">
	<tr>
		...
		if ( ! wc_ship_to_billing_address_only() && $order->needs_shipping_address() && ( $shipping ) ) :
			?>
			<td class="td" style="font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" valign="top">
				<h3><?php esc_html_e( 'Shipping address', 'smart-emails' ); ?></h3>

				<p class="address" style="text-align:left"><?php echo wp_kses_post( $shipping ); ?></p>
			</td>
		<?php endif; ?>
	</tr>
</table>
