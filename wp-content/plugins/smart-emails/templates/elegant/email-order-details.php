	...
	<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; border-bottom: 1px solid #dcdcdc; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">
		<thead style="background-color:#dcdcdc">
			<tr>
				...
				<th></th>
				<th class="td" scope="col" style="text-align:center;border-top: 1px solid #dcdcdc"><?php esc_html_e( 'Quantity', 'smart-emails' ); ?></th>
				<th class="td" scope="col" style="text-align:right;border-top: 1px solid #dcdcdc"><?php esc_html_e( 'Price', 'smart-emails' ); ?></th>
			</tr>
		</thead>
		<tbody>
			<?php
